...
const item = { id: "blitz-1", title: "Proposal", revision: 3, payload: { sourceAssetId: "source", sourceMediaType: "video", sourceAttribution: "https://example.com/source", rightsSnapshot: { id: "rights", revision: 1, digest: `sha256:${"b".repeat(64)}` }, rightsBasis: "licensed", permittedRemix: "transform", rightsEvidenceIds: ["rights"], contentLanguage: "ar", arabicVariety: "gulf", format: "video_hook_demo", rationale: "Original Arabic remix", remixBrief: { influences: ["topic"], protectedExpressionExcluded: true }, sourceComparison: { views: 10, likes: 2, observedAt: "2026-09-04T00:00:00.000Z" } } };
