      ...
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        <section className="rounded-xl border border-neutral-800 bg-neutral-900 p-5">
          ...
          <form onSubmit={(event) => void lookupTrace(event).catch((cause) => setError(String(cause)))} className="mt-4 flex flex-wrap gap-2">
            <input name="operatorTraceRef" aria-label={t("trace.reference")} required placeholder="otr_…" className="min-w-64 flex-1 rounded-md border border-neutral-700 bg-neutral-950 px-3 py-2 text-sm" />
