...
export async function AutomationsScreen({ selectedAutomationId = null }: { selectedAutomationId?: string | null }) {
  ...
  const [t, rows, options, calendarPreferences, defaultContentLanguage] = await Promise.all([
