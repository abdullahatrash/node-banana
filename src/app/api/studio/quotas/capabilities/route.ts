  ...
  async (request: NextRequest, authz) => {
    ...
    if (
      ...
      return noStoreJson(
        {
          success: false,
          error: "Only Workspace owners and admins can manage quotas.",
        },
        { status: 403 },
      );
    }
    ...
    try {
      ...
      return noStoreJson(
        { success: false, error: "Invalid Quota capability invocation." },
        { status: 400 },
      );
    }
      ...
      return noStoreJson(
        {
          ...
          error:
            "Idempotency-Key with 8 to 200 printable characters is required for this Quota mutation.",
        },
        { status: 400 },
      );
    }
