...
export const POST = withStudioAuth<undefined>({ route: "/api/studio/product-telemetry/consent", action: "write", permission: "product:read" }, async (request: NextRequest, authz) => {
