...
const REGIONS = ["SA", "AE", "EG", "KW", "QA", "BH", "OM", "JO", "LB", "MA", "DZ", "TN", "IQ"] as const;

export function YoutubeTrendDiscovery({ data }: { data: YoutubeTrendDiscoveryData }) {
