...
it("seeks across a one-frame deletion even when ordinary playback drift is below 100ms", () => {
  ...
  const seek = vi.spyOn(HTMLMediaElement.prototype, "currentTime", "set").mockImplementation(() => {});
  ...
  render(<Preview composition={{ ...emptyComposition(), main: { ...createClip("main", 5), segments: [{ trimStart: 0, trimEnd: 2 }, { trimStart: 2 + 1 / 30, trimEnd: 5 }] } }}
    media={{ main: { id: "main", name: "Phone", url: "https://media.example/main.mp4", type: "video", duration: 5, width: 1080, height: 1920 } }} copy={editorCopy.en} onChange={vi.fn()} onSelectText={vi.fn()} />);
