const en = {
 upload: 'Upload video or audio', uploading: 'Uploading…', processing: 'Checking media…', secondary: 'Secondary video', position: 'Start on timeline', remove: 'Remove', addTo: 'Add media to', layouts: { stacked: 'Stacked', pip: 'Picture in picture', 'side-by-side': 'Side by side' }, title: 'Video editor', untitled: 'Untitled video', back: 'Back to studio', media: 'Workspace media', main: 'Main video',
...
const ar: typeof en = {
 upload: 'رفع فيديو أو صوت', uploading: 'جارٍ الرفع…', processing: 'جارٍ فحص الوسائط…', secondary: 'الفيديو الثانوي', position: 'البداية على الخط الزمني', remove: 'إزالة', addTo: 'إضافة الوسائط إلى', layouts: { stacked: 'فوق وتحت', pip: 'صورة داخل صورة', 'side-by-side': 'جنباً إلى جنب' }, title: 'محرر الفيديو', untitled: 'فيديو جديد', back: 'العودة للاستوديو', media: 'وسائط مساحة العمل', main: 'الفيديو الأساسي',
