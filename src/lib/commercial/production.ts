...
import { ConfiguredReferralPayoutProvider } from "./referral-payout-provider";
import { PostgresReferralPayoutDispatchStore, ReferralPayoutDispatchService } from "./referral-payout-dispatch";
...
export const REFERRAL_PAYOUT_PROVIDER = new ConfiguredReferralPayoutProvider();
export const REFERRAL_PAYOUT_DISPATCH = new ReferralPayoutDispatchService(new PostgresReferralPayoutDispatchStore(getDb(), COMMERCIAL), REFERRAL_PAYOUT_PROVIDER);
