...
export class CommercialRepository {
  ...
  async referralDashboard(workspaceId: string) {
    const [codes, captureStates, attributionStates, rewards, payoutEntries] = await Promise.all([
