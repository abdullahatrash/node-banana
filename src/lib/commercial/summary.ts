...
export function readCommercialSummary(value: unknown): CommercialSummary | null {
  ...
  if (!summary.credit || typeof summary.credit.availableUnits !== "number" || typeof summary.credit.liabilityUnits !== "number" || !Array.isArray(summary.plans) || !summary.financials || !Array.isArray(summary.financials.transactions) || !Array.isArray(summary.financials.adjustments)) return null;
