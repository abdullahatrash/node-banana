const SAFE_KEY = /^(count|attempt|durationMs|progress|providerFamily|modelFamily|provider|model|version|inputSchemaDigest|qualificationDigest|region|regionPolicyId|regionPolicyVersion|regionEvidenceDigest|language|contentLanguage|arabicVariety|format|contentFormat|aspectRatio|width|height|fps|sourceAdapter|sourceUpdatedAt|intentId|predictionId|providerState|providerCode|providerOperationRef|nextAction|reasonCode|retryable|principalId|authorizationEvidenceRef|workflowId|workflowRunId|automationId|campaignId|campaignRevision|scheduledAt|channelId|personaId|trainingJobId|sourceId|resourceVersion|brandProfileId|brandRevision|brandContextDigest|quoteId|quoteAmountUsd|quoteCurrency|quoteQuantity|quoteBasis|actualAmountUsd|releasedAmountUsd|reservationIds|rightsSnapshotId|rightsSnapshotRevision|rightsEvidenceRefs|provenanceRefs|brandReferenceAssetIds|artifactIds|artifactCount|textOutputIds|textOutputCount|retrySourceOccurrenceId)$/;
