...
ALTER TABLE "social_posts" ADD CONSTRAINT "social_posts_root_post_id_social_posts_id_fk" FOREIGN KEY ("root_post_id") REFERENCES "public"."social_posts"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "social_posts" ADD CONSTRAINT "social_posts_source_template_post_id_social_posts_id_fk" FOREIGN KEY ("source_template_post_id") REFERENCES "public"."social_posts"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "social_posts_trigger_source_idx" ON "social_posts" USING btree ("trigger_source");--> statement-breakpoint
...
CREATE INDEX "social_automation_tasks_created_at_idx" ON "social_automation_tasks" USING btree ("created_at");
