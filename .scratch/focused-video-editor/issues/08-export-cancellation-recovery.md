# 08: Recover cleanly from export cancellation and failure

**What to build:** A creator can cancel preparation or rendering, handle an unsupported file/browser or interrupted attempt, and successfully export again without accumulating temporary media.

**Blocked by:** 06: Add Music and Voiceover with independent controls.
